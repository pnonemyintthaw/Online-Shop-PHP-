		                ...
		                <div class="item">
		                    <div class="pad15">
		                    	<a href="item_detail.php?id=<?= $di_id ?>">
		                    		<img src="<?= $di_photo ?>" class="img-fluid"></a>
		                        <p class="text-truncate"><?= $di_name ?></p>
		                        <p class="item-price">
		                        	<strike><?= $di_price ?><span>Ks</span> </strike> 
		                        	<span class="d-block"><?= $di_discount ?><span>Ks</span></span>
		                        </p>
								...
								<a href="" class="addtocartBtn text-decoration-none" data-id="<?= $di_id;?>" data-name="<?= $di_name;?>" data-codeno="<?= $di_codeno;?>"data-photo="<?= $di_photo;?>" data-price="<?= $di_price;?>" data-discount="<?= $di_discount;?>">Add to Cart</a>
			...
			<div class="col-12">
				<div class="MultiCarousel" data-items="1,3,5,6" data-slide="1" id="MultiCarousel"  data-interval="1000">
		            <div class="MultiCarousel-inner">
		                ...
		                <div class="item">
		                    <div class="pad15">
		                    	<a href="item_detail.php?id=<?= $sa_id ?>">
		                    		<img src="<?= $sa_photo; ?>" class="img-fluid"></a>
		                        <p class="text-truncate"><?=$sa_name;?></p>
		                        <p class="item-price">
		                        	<?php if($sa_discount) { ?>
		                        	<strike><?=$sa_price;?><span>Ks</span> </strike> 
		                        	<span class="d-block"><?=$sa_discount;?><span>Ks</span></span>
		                        	<?php } else{?>
		                        		<span class="d-block"><?=$sa_price;?><span>Ks</span></span>
		                        	<?php }?>
		                        </p>
		...
		<div class="row">
			<div class="col-12">
				<div class="MultiCarousel" data-items="1,3,5,6" data-slide="1" id="MultiCarousel"  data-interval="1000">
		            <div class="MultiCarousel-inner">
		                <?php
		            	$sql = 'SELECT * FROM items WHERE subcategory_id=1 LIMIT 8';
		            	$stmt = $conn->prepare($sql);
		            	$stmt->execute();
		                ...
		                <div class="item">
		                    <div class="pad15">
		                    	<a href="item_detail.php?id=<?= $ra_id ?>">
		                    		<img src="<?= $ra_photo; ?>" class="img-fluid">
		                    	</a>
		                        <p class="text-truncate"><?= $ra_name; ?></p>
		                        <p class="item-price">
		                        	<?php if($ra_discount) { ?>
		                        	<strike><?=$ra_price;?><span>Ks</span> </strike> 
		                        	<span class="d-block"><?=$ra_discount;?><span>Ks</span></span>
		                        	<?php } else{?>
		                        		<span class="d-block"><?=$ra_price;?><span>Ks</span></span>
		                        	<?php }?>
		                        </p>

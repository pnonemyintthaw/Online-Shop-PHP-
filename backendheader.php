...
<html lang="en">
    ...
    <body class="app sidebar-mini">
        ...
        <aside class="app-sidebar">
            ...
            <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="images/brands/bella_logo.png" alt="User Image" width="50" height="45">
                <div>
                 <?php
            ...
            <ul class="app-menu">
                ...
                <li>
                    <a class="app-menu__item" href="subcategories_list.php">
                ...
                <li>
                    <a class="app-menu__item" href="categories_list.php">

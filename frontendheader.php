		...
		<div class="row shadow-sm p-3 bg-white rounded d-flex align-items-center">
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 order-xl-3 order-lg-3 order-md-4 order-sm-4 order-4 text-right">
				...
				<a href="shopping_cart.php" class="text-decoration-none d-xl-inline d-lg-inline d-md-inline d-sm-none d-none shoppingcartLink"> 
					...
					<span id="cart" class="badge badge-pill badge-light badge-notify cartNotistyle cartNoti"> </span>
					<span id="cart_ks">  </span><span>Ks</span>
				</a>
                        ...
                        ?>
			          	...
			          	<li class="dropdown-submenu">
				            ...
				            <ul class="dropdown-menu">
				            	...
				            	<?php 
				            	$sql = "SELECT * FROM subcategories WHERE categories_id = :value1";
				            	$stmt = $conn->prepare($sql);
	...
	<div id="mySidebar" class="sidebar">
		...
		<div class="mt-3">
			...
			<hr>
		  	...
		  	<a data-toggle="collapse" href="#brand_<?=$id;?>" role="button" aria-expanded="false" aria-controls="brand">
		   		Merchants
		   		<i class="icofont-rounded-down float-right mr-3"></i>

		  	</a>

			<div class="collapse sidebardropdown_container_category mt-3" id="brand_<?=$id;?>">
				<?php
				$sql= "SELECT * FROM brands";
				$stmt= $conn->prepare($sql);
				$stmt->execute();
			...
			<hr>
				...
				if(isset($_SESSION['login_user'])){
					...
					<a data-toggle="collapse" href="#service1" role="button" aria-expanded="false" aria-controls="service">
						<?= $_SESSION['login_user']['name']; ?>
						<i class="icofont-rounded-down float-right mr-3"></i>
					</a>

					<div class="collapse sidebardropdown_container_category mt-3" id="service1">
						<a href="" class="py-2"> Profile </a>
						<a href="" class="py-2"> Order Hiatory</a>
						<a href="signout.php" class="py-2"> log out </a>
			...
			<a href="shopping_cart.php"> Cart  [<span class="cartNoti" id="cart"> 1 </span>  ] </a>
			<hr>
